...
namespace EnhancedHierarchy {
    internal static partial class Preferences {
        ...
        private static readonly Version pluginVersion = new Version(2, 4, 2);
        private static readonly DateTime pluginDate = new DateTime(2019, 01, 10);
        ...
        private static SettingsProvider RetrieveSettingsProvider() {
            var settingsProvider = new SettingsProvider("Enhanced Hierarchy", SettingsScope.User, contents.Select(c => c.text));
